...
class MassAnswered extends Action implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        foreach ($collection as $contact) {
            $contact->setIsActive(Contact::STATUS_ANSWERED)->save();
        }

        $message = __('A total of %1 record(s) have been enable.', $collectionSize);
