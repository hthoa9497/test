...
namespace Magezon\AdvancedContact\Ui\Component\Form\Field;
...
class Attachment extends Field
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['attachment']) && !empty($dataSource['data']['attachment'])) {
            $dataSource['data']['attachment'] = html_entity_decode('<a href="' . $path . $dataSource['data']['attachment'] . '" target="_blank"> Attachment </a>');
        }
